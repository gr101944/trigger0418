...
module.exports = async function (context, myBlob) {
    ...
    const querySpec = {
        query: "SELECT *  from " + collectionName + " c    WHERE c.domainName = " + "'" + homeDomain + "'"
    };
   ...
   // Build your path URL.
    ...
    var fileName = context.bindingData.blobTrigger;
    var urlPath = storageName  + fileName;
    ...
    let patch = function(path, content, callback) {
        ...
        console.log ("request_params " + JSON.stringify (request_params));
    ...
    update_kb(path, content, function (result) {
        context.log ("Calling update_kb function")
        console.log ("path in update_kb " + path)
