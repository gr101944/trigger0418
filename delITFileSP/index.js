...
const containerNameITServices = "itservices";


module.exports = async function (context, myQueueItem) {
    
    //Get People KB Name
    const itDomain = "IT Services";

    const querySpec = {
        query: "SELECT *  from " + collectionName + " c    WHERE c.domainName = " + "'" + itDomain + "'"
    };
   ...
   // console.log("FileName " + context.bindingData.blobTrigger);
    ...
    console.log ("Fine name in the Queue " + myQueueItem)
    var urlPath = storageName  + containerNameITServices + "/" + fileName;
